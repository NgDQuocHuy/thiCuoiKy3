                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="text-primary">Create New</h3>
                                        ...
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" name="name" id="name" value="${requestScope.product.getName()}" placeholder="Input title..."/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-0">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" type="text" name="color" id="color" value="${requestScope.product.getColor()}" placeholder="Input color..."/>
                                                </div>
                                            </div>
